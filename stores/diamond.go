...
func NewDiamond(address fields.Address) *Diamond {
	...
	return &Diamond{
		...
		Address:                 addr,
		EngravedPrevBlockHeight: fields.BlockHeight(0),
...
func (this *Diamond) Size() uint32 {
	return this.Status.Size() +
		this.Address.Size() +
		this.EngravedPrevBlockHeight.Size() +
...
func (this *Diamond) Serialize() ([]byte, error) {
	...
	b3, _ := this.EngravedPrevBlockHeight.Serialize()
	b4, _ := this.EngravedContents.Serialize()
	buffer.Write(b1)
	buffer.Write(b2)
	buffer.Write(b3)
	buffer.Write(b4)
...
func (this *Diamond) Parse(buf []byte, seek uint32) (uint32, error) {
	...
	seek, e = this.EngravedPrevBlockHeight.Parse(buf, seek)
	if e != nil {
		return 0, e
	}
